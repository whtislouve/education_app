...
class _$TopicImpl with DiagnosticableTreeMixin implements _Topic {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Topic(title: $title, shortDescription: $shortDescription, fullDescription: $fullDescription, subTopics: $subTopics, instructors: $instructors)';
  }
...
abstract class _Topic implements Topic {
  const factory _Topic(
      ...
      required final List<SubTopics> subTopics,
      required final List<Instructors> instructors}) = _$TopicImpl;
...
abstract class _Instructors implements Instructors {
  const factory _Instructors(
      ...
      required final String lastName}) = _$InstructorsImpl;
